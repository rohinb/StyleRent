...
//        self.typingIndicatorContainerView.layoutIfNeeded()
    ...
    func scrollToBottom(force: Bool) {
        ...
        self.chattingTableView.scrollToRow(at: IndexPath.init(row: self.messages.count - 1, section: 0), at: UITableViewScrollPosition.bottom, animated: true)
    }
    ...
    func scrollToPosition(position: Int) {
        ...
        self.chattingTableView.scrollToRow(at: IndexPath.init(row: position, section: 0), at: UITableViewScrollPosition.top, animated: true)
    }
